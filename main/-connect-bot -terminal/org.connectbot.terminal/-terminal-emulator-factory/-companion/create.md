...
| inlineImagesEnabled | Accept iTerm2 and Kitty inline images. Defaults to true. |
| inlineImageLimits | RAM and metadata limits for inline image processing. |