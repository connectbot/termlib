...
/** Protocol data from https://sw.kovidgoyal.net/kitty/graphics-protocol/#unicode-placeholders. */
internal object KittyPlaceholder {
    ...
    fun index(codepoint: Int): Int = diacritics.indexOf(codepoint)
}
