...
| [inlineImagesEnabled](inline-images-enabled.md) | [release]<br>abstract val [inlineImagesEnabled](inline-images-enabled.md): [Boolean](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html)<br>Whether incoming inline image commands are accepted. Enabled by default. |
...
| [pasteText](paste-text.md) | [release]<br>abstract fun [pasteText](paste-text.md)(text: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html))<br>Queue pasted text in the same FIFO as keyboard/IME input, honoring bracketed paste. |
...
| [setCellPixelSize](set-cell-pixel-size.md) | [release]<br>abstract fun [setCellPixelSize](set-cell-pixel-size.md)(width: [Int](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html), height: [Int](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html))<br>Physical cell dimensions used by image placement; defaults to 8 by 16 pixels. |
